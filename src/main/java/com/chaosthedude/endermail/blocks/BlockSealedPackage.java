...
public class BlockSealedPackage extends Block implements ITileEntityProvider {

	public static final String NAME = "sealed_package";
	public static final int SIZE = 5;

	public BlockSealedPackage() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (ItemUtils.isHolding(player, EnderMailItems.stamp)) {
			player.openGui(EnderMail.instance, GuiHandler.CONTROLLER_ID, world, pos.getX(), pos.getY(), pos.getZ());
			return true;
