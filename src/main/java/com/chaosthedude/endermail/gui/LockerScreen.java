...
public class LockerScreen extends ContainerScreen<LockerContainer> implements IHasContainer<LockerContainer> {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		idTextField.render(mouseX, mouseY, partialTicks);
		renderHoveredToolTip(mouseX, mouseY);
	}

	@Override
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		font.drawString(I18n.format("block.endermail.locker"), 8, 6, 4210752);
		font.drawString(I18n.format("string.endermail.id"), 75, 6, 4210752);
